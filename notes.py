...
# A parameter is a variable used at the start of the function.
# An argument is value given to the function when called.
# The return value is the value given back to where you called the function.
...
# print: is a side effect. Prints to the terminal or console.
# return: is not a side effect. Gives a value back to where the function was called.
